            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Last updated on {formatDate(currentRequest.updatedAt)}</p>
                </div>
              ...
              <div className="space-y-2">
                <p className="text-sm font-medium text-gray-600">Hidden Status</p>
                <p className="text-gray-900">{currentRequest.hidden ? 'Yes' : 'No'}</p>
              </div>
            </div>
          </div>
        </div>
...
export default function OrderRequestManager() {
  ...
  const fetchOrderRequests = async () => {
    try {
      ...
      alert('Failed to fetch order requests');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="space-y-6">
        ...
        {/* <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              <input
                type="text"
                placeholder="Search by Request ID, Order ID, or Main Order ID..."
                value={searchTerm}
        ...
        {loading && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
            ...
            <p className="text-gray-600">Loading order requests...</p>
          </div>
        )}
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-sm">
                        ...
                        <div className="flex items-center text-gray-600">
                          ...
                          Main: {request.mainOrderId?.slice(-6) || 'N/A'}
                        </div>
                        <div className="flex items-center text-gray-600">
